...
void export_PerturbedLennardJonesEvapGPU(py::module& m)
    ...
    py::class_<PerturbedLennardJonesEvapGPU,
        ...
        .def_property_readonly("rcut", &PerturbedLennardJonesEvapGPU::getRCut)
        .def_property_readonly("epsilon", &PerturbedLennardJonesEvapGPU::getEpsilon)
        .def_property_readonly("sigma", &PerturbedLennardJonesEvapGPU::getSigma);
    }

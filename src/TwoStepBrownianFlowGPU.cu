...
brownian_flow<azplugins::ConstantFlow>(Scalar4* d_pos,
                                       int3* d_image,
                                       const BoxDim& box,
...
template cudaError_t
brownian_flow<azplugins::ParabolicFlow>(Scalar4* d_pos,
                                        int3* d_image,
                                        const BoxDim& box,
                                        const Scalar4* d_net_force,
                                        const unsigned int* d_tag,
...
template cudaError_t
brownian_flow<azplugins::QuiescentFluid>(Scalar4* d_pos,
                                         int3* d_image,
                                         const BoxDim& box,
                                         const Scalar4* d_net_force,
                                         const unsigned int* d_tag,

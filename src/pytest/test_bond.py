...
potential_tests += [
    ...
    PotentialTestCase(
        ...
        dict(epsilon=0.0,sigma=0.0,k=1434.3,r_0=1.5,b_1=-0.7589,b_2=0,U_0=67.2234,delta=0.0),
        1,
        20.80586625,
        -99.2177025,
    ),
    # test potential with sigma != 0, epsilon = 0
    PotentialTestCase(
        hoomd.azplugins.bond.Quartic,
        dict(epsilon=0.0,sigma=1.0,k=1434.3,r_0=1.5,b_1=-0.7589,b_2=0,U_0=67.2234,delta=0),
        1,
        20.80586625,
        -99.2177025,
    ),
    ...
    PotentialTestCase(
        hoomd.azplugins.bond.Quartic,
        dict(epsilon=1.0,sigma=0.0,k=1434.3,r_0=1.5,b_1=-0.7589,b_2=0,U_0=67.2234,delta=0),
        1,
        20.80586625,
        -99.2177025,
    ),
    ...
    # test potential without delta passed
    PotentialTestCase(
        hoomd.azplugins.bond.Quartic,
        dict(epsilon=1.0, sigma=1.0, k=1434.3,r_0=1.5,b_1=-0.7589, b_2=0,U_0=67.2234),
        1,
        21.80586625,
        -75.2177025,
    ),

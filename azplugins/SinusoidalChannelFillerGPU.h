...
#ifndef AZPLUGINS_MPCD_SINE_CHANNEL_GEOMETRY_FILLER_GPU_H_
#define AZPLUGINS_MPCD_SINE_CHANNEL_GEOMETRY_FILLER_GPU_H_
...
#endif // AZPLUGINS_MPCD_SINE_CHANNEL_GEOMETRY_FILLER_GPU_H_

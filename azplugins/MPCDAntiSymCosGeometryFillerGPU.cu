...
/*!
 * \file MPCDAntiSymCosGeometryFillerGPU.cu
 * \brief Defines GPU functions and kernels used by azplugins::gpu::AntiSymCosGeometryFillerGPU
 */
...
__global__ void anti_sym_cos_draw_particles(Scalar4 *d_pos,
    ...
    hoomd::RandomGenerator rng(RNGIdentifier::AntiSymCosGeometryFiller, seed, tag, timestep);

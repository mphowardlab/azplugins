...
#ifndef AZPLUGINS_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_
#define AZPLUGINS_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_
...
#endif // AZPLUGINS_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_

...
class lj93(hoomd.md.wall.wallpotential):
    ...
    Example::
        ...
        lj93.force_coeff.set('A', sigma=1.0, epsilon=1.0)
        lj93.force_coeff.set('B', sigma=1.0, epsilon=1.0, r_cut=np.power(2.0/5.0, 1.0/6.0))
        lj93.force_coeff.set(['A','B'], epsilon=2.0, sigma=1.0, r_cut=2.0)
    """

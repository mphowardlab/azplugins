...
#ifndef AZPLUGINS_BOUNCE_BACK_NVE_H_
#define AZPLUGINS_BOUNCE_BACK_NVE_H_
...
void BounceBackNVE<Geometry>::integrateStepOne(unsigned int timestep)
    ...
    if (m_aniso)
        {
        m_exec_conf->msg->error() << "azplugins.integrate: anisotropic particles are not supported with bounce-back integrators." << std::endl;
...
#endif // #ifndef AZPLUGINS_BOUNCE_BACK_NVE_H_

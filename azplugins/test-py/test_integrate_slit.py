...
class integrate_slit_tests(unittest.TestCase):
    ...
    def test_create(self):
        azplugins.integrate.slit(group=self.group, H=4., V=0.1, boundary="no_slip")

    # test for setting parameters
    def test_set_params(self):
        slit = azplugins.integrate.slit(group=self.group, H=4.)
    ...
    def test_step_noslip(self):
        azplugins.integrate.slit(group=self.group, H=4.)
    ...
    def test_step_moving_wall(self):
        ...
        azplugins.integrate.slit(group=self.group, H=4., boundary="no_slip", V=1.0)
    ...
    def test_step_slip(self):
        azplugins.integrate.slit(group=self.group, H=4., boundary="slip")
    ...
    def test_validate_box(self):
        ...
        slit = azplugins.integrate.slit(group=self.group, H=10.)
    ...
    def test_out_of_bounds(self):
        slit = azplugins.integrate.slit(group=self.group, H=3.8)
        with self.assertRaises(RuntimeError):
            hoomd.run(1)

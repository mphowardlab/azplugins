...
class restrain_cylinder_tests(unittest.TestCase):
    ...
    def test_force(self):
        ...
        hoomd.run(1)
        np.testing.assert_array_almost_equal(f.forces[0].force, (0,0,2.))
        np.testing.assert_array_almost_equal(f.forces[1].force, (0,0,0))
        np.testing.assert_array_almost_equal(f.forces[2].force, (0,0,10.))
        ...
        np.testing.assert_array_almost_equal(f.forces[2].virial, (0,0,0,0,0,30.))

        # change the spring constant
        f.set_params(k=1.0)
        hoomd.run(1)
        np.testing.assert_array_almost_equal(f.forces[0].force, (0,0,1.))
        np.testing.assert_array_almost_equal(f.forces[1].force, (0,0,0))
        np.testing.assert_array_almost_equal(f.forces[2].force, (0,0,5.))
        ...
        np.testing.assert_array_almost_equal(f.forces[0].virial, (0,0,0,0,0,0))
        np.testing.assert_array_almost_equal(f.forces[1].virial, (0,0,0,0,0,-2.))
        ...
        np.testing.assert_array_almost_equal(f.forces[1].virial, (0,0,0,0,0,0))
        np.testing.assert_array_almost_equal(f.forces[2].virial, (20.,0,30.,0,0,0))

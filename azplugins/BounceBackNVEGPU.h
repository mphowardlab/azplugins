...
#ifndef AZPLUGINS_BOUNCE_BACK_NVE_GPU_H_
#define AZPLUGINS_BOUNCE_BACK_NVE_GPU_H_
...
void BounceBackNVEGPU<Geometry>::integrateStepOne(unsigned int timestep)
    ...
    if (this->m_aniso)
        {
        this->m_exec_conf->msg->error() << "azplugins.integrate: anisotropic particles are not supported with bounce-back integrators." << std::endl;
...
#endif // AZPLUGINS_BOUNCE_BACK_NVE_GPU_H_

...
#ifndef AZPLUGINS_MPCD_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_
#define AZPLUGINS_MPCD_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_
...
#endif // AZPLUGINS_MPCD_SINE_EXPANSION_CONSTRICTION_GEOMETRY_FILLER_H_
